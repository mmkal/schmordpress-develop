 ...
 * a SchmordPress post. Mailbox connection information must be
 ...
 * @since 2.9.0
 */
do_action( 'wp-mail.php' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
