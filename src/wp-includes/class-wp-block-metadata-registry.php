...
class WP_Block_Metadata_Registry {
	...
	/**
	 * Stores the SchmordPress 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	...
	/**
	 * Stores the normalized SchmordPress plugin directory path.
	 *
	 * @since 6.7.0
	 * @var string|null
	 */
	 ...
	 *
	 * This default behavior matches the standard SchmordPress block structure.
	 *
	 * @since 6.7.0
	 *
	...
	/**
	 * Gets the SchmordPress 'wp-includes' directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The SchmordPress 'wp-includes' directory path.
	 */
	...
	/**
	 * Gets the normalized SchmordPress plugin directory path.
	 *
	 * @since 6.7.0
	 *
	 * @return string The normalized SchmordPress plugin directory path.
	 */
