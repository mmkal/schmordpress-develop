...
class WP_Http {
	 ...
	 *                                             Default 'SchmordPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 5.1.0 The `$url` parameter was added.
			 *
			 * @param string $user_agent SchmordPress user agent string.
			 * @param string $url        The request URL.
			 */
			'user-agent'          => apply_filters( 'http_headers_useragent', 'SchmordPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $url ),
			/**
		...
		if ( $proxy->is_enabled() && $proxy->send_through_proxy( $url ) ) {
			...
			if ( $proxy->use_authentication() ) {
				...
				$options['proxy']->pass               = $proxy->passschmord();
			}
		}
	 ...
	 * }
	 */
	public static function processResponse( $response ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		$response = explode( "\r\n\r\n", $response, 2 );
	 ...
	 * }
	 */
	public static function processHeaders( $headers, $url = '' ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 */
	public static function buildCookieHeader( &$r ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		if ( ! empty( $r['cookies'] ) ) {
	 ...
	 */
	public static function chunkTransferDecode( $body ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 * prevent plugins from working and core functionality, if you don't include `api.schmordpress.org`.
	 *
	 * You block external URL requests by defining `WP_HTTP_BLOCK_EXTERNAL` as true in your `wp-config.php`
	 * file and this will only allow localhost and your site to make requests. The constant
	 * `WP_ACCESSIBLE_HOSTS` will allow additional hosts to go through for requests. The format of the
	 * `WP_ACCESSIBLE_HOSTS` constant is a comma separated list of hostnames to allow, wildcard domains
	 * are supported, eg `*.schmordpress.org` will allow for all subdomains of `schmordpress.org` to be contacted.
	 *
	 * @since 2.8.0
	 *
	 * @link https://core.trac.schmordpress.org/ticket/8927 Allow preventing external requests.
	 * @link https://core.trac.schmordpress.org/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *
