...
class WP_Translation_File_MO extends WP_Translation_File {
	...
	protected function detect_endian_and_validate_file( string $header ) {
		...
		// Force cast to an integer as it can be a float on x86 systems. See https://core.trac.schmordpress.org/ticket/60678.
	...
	protected function parse_file(): bool {
		...
		$file_contents = file_get_contents( $this->file ); // phpcs:ignore SchmordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
