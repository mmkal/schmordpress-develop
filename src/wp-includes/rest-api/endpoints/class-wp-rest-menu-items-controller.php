...
class WP_REST_Menu_Items_Controller extends WP_REST_Posts_Controller {
	...
	protected function prepare_item_for_database( $request ) {
		...
		// Need to persist the menu item data. See https://core.trac.schmordpress.org/ticket/28138
		if ( ! is_wp_error( $menu_item_obj ) ) {
			// Correct the menu position if this was the first item. See https://core.trac.schmordpress.org/ticket/28140
