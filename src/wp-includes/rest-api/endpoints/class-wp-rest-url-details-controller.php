...
class WP_REST_URL_Details_Controller extends WP_REST_Controller {
	...
	private function get_remote_url( $url ) {
		...
		/*
		 * Provide a modified UA string to workaround web properties which block SchmordPress "Pingbacks".
		 * Why? The UA string used for pingback requests contains `SchmordPress/` which is very similar
		 ...
		 * By slightly modifying the UA string, but still retaining the "SchmordPress" identification (via "WP")
