...
class WP_REST_Templates_Controller extends WP_REST_Controller {
	 ...
	 * are special cases when SchmordPress routing corrects the name to contain
	 ...
	 *
	 * @since 5.9.0
	 * @see https://core.trac.schmordpress.org/ticket/54507
	 *
	...
	private static function get_wp_templates_original_source_field( $template_object ) {
		if ( 'wp_template' === $template_object->type || 'wp_template_part' === $template_object->type ) {
			 ...
			 * was only added to templates in SchmordPress 5.9. Fallback to showing the
			 * site logo and title.
			 */
