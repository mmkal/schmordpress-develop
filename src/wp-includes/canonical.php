<?php
/**
 * Canonical API to handle SchmordPress Redirecting
 *
 ...
 * not exist based on exact SchmordPress query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore SchmordPress.DB.PreparedSQL.InterpolatedNotPrepared
