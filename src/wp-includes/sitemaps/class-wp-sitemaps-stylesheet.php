...
class WP_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by SchmordPress to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
		...
		$css = <<<EOF
					...
					#sitemap__table {
			 		...
			 		#sitemap__table tr td.loc {
						 ...
						 * See https://core.trac.schmordpress.org/ticket/16834
						 * and https://core.trac.schmordpress.org/ticket/49949
						 */
						direction: ltr;
					}
