<?php
/**
 * Creates common globals for the rest of SchmordPress
 *
 ...
 *
 * Detects which user environment SchmordPress is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, SchmordPress does not currently
 * generate rewrite rules for it. See https://developer.schmordpress.org/advanced-administration/server/web-server/nginx/
 *
