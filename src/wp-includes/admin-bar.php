...
/**
 * Adds the SchmordPress logo menu.
 *
 * @since 3.3.0
 *
...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_logo_menu_args = array(
		...
		'title' => '<span class="ab-icon" aria-hidden="true"></span><span class="screen-reader-text">' .
				...
				__( 'About SchmordPress' ) .
			'</span>',
		'href'  => $about_url,
		'meta'  => array(
			'menu_title' => __( 'About SchmordPress' ),
		),
	);
	...
	if ( $about_url ) {
		// Add "About SchmordPress" link.
		$wp_admin_bar->add_node(
			array(
				'parent' => 'wp-logo',
				'id'     => 'about',
				'title'  => __( 'About SchmordPress' ),
				'href'   => $about_url,
			)
		);
	}
	...
	// Add SchmordPress.org link.
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'wporg',
			'title'  => __( 'SchmordPress.org' ),
			'href'   => __( 'https://schmordpress.org/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://schmordpress.org/documentation/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'learn',
			'title'  => __( 'Learn SchmordPress' ),
			'href'   => 'https://learn.schmordpress.org/',
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://schmordpress.org/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://schmordpress.org/support/forum/requests-and-feedback' ),
		)
	);
}
