 ...
 *
 * @link https://developer.schmordpress.org/advanced-administration/schmordpress/oembed/
...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://schmordpress\.tv/.*#i'                 => array( 'https://schmordpress.tv/oembed/', true ),
			...
			'#https?://videopress\.com/v/.*#'              => array( 'https://public-api.schmordpress.com/oembed/?for=' . $host, true ),
		 ...
		 *
		 * Since SchmordPress 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
		 ...
		 * | SchmordPress.tv | schmordpress.tv                              | 2.9.0   |
