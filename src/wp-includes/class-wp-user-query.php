...
class WP_User_Query {
	 ...
	 *     @type string          $search              Search keyschmord. Searches for possible string matches on columns.
	...
	public function query() {
		 ...
		 *
		 * Return a non-null value to bypass SchmordPress' default user queries.
		 *
