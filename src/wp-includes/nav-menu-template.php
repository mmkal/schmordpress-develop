...
function wp_nav_menu( $args = array() ) {
	...
	foreach ( (array) $menu_items as $menu_item ) {
		/*
		 * Fix invalid `menu_item_parent`. See: https://core.trac.schmordpress.org/ticket/56926.
 ...
 * SchmordPress 3.0.0 so this needs to allow for cases in which the filter is
 * called without them.
 *
 * @see https://core.trac.schmordpress.org/ticket/56926
 *
 * @since 6.2.0
 *
