...
class WP_Widget_Meta extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => __( 'Login, RSS, &amp; SchmordPress.org links.' ),
	...
	public function widget( $args, $instance ) {
		...
		<ul>
			...
			<?php
			/**
			 * Filters the "SchmordPress.org" list item HTML in the Meta widget.
			 *
			 * @since 3.6.0
			 * @since 4.9.0 Added the `$instance` parameter.
			 *
			 * @param string $html     Default HTML for the SchmordPress.org list item.
