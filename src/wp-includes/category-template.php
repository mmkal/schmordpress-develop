 ...
 */
function get_the_category_by_ID( $cat_id ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$cat_id   = (int) $cat_id;
 ...
 *
 * Prior to v2.5 of SchmordPress, category names were not supported.
 * Prior to v2.7, category slugs were not supported.
 * Prior to v2.7, only one category could be compared: in_category( $single_category ).
 * Prior to v2.7, this function could only be used in the SchmordPress Loop.
...
function get_the_term_list( $post_id, $taxonomy, $before = '', $sep = '', $after = '' ) {
	 ...
	 */
	$term_links = apply_filters( "term_links-{$taxonomy}", $links );  // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.7.0 Can be used outside of the SchmordPress Loop if `$post` is provided.
 *
