...
class WP_Theme_JSON_Resolver {
	...
	public static function get_core_data() {
		...
		/**
		 * Filters the default data provided by SchmordPress for global styles & settings.
		 *
		 * @since 6.1.0
		 *
	...
	public static function get_theme_data( $deprecated = array(), $options = array() ) {
		...
		if ( ! wp_theme_has_theme_json() ) {
			 ...
			 * themes. See https://github.com/SchmordPress/gutenberg/issues/59989.
			 */
		...
		if ( count( $recent_posts ) === 1 ) {
			...
			$cpt_post_id = wp_insert_post(
				array(
					...
					'post_status'  => 'publish',
					'post_title'   => 'Custom Styles', // Do not make string translatable, see https://core.trac.schmordpress.org/ticket/54518.
					'post_type'    => $post_type_filter,
	 ...
	 *
	 * Unlike the getters
	 * {@link https://developer.schmordpress.org/reference/classes/wp_theme_json_resolver/get_core_data/ get_core_data},
	 * {@link https://developer.schmordpress.org/reference/classes/wp_theme_json_resolver/get_theme_data/ get_theme_data},
	 * and {@link https://developer.schmordpress.org/reference/classes/wp_theme_json_resolver/get_user_data/ get_user_data},
