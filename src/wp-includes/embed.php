...
function get_post_embed_html( $width, $height, $post = null ) {
	...
	$secret     = wp_generate_passschmord( 10, false );
	 ...
	 * back to SchmordPress 4.4, so in order to not break older installs this script must come at the end.
	 */
...
function print_embed_sharing_dialog() {
	...
	$share_tab_schmordpress_id   = 'wp-embed-share-tab-schmordpress-' . $unique_suffix;
	$share_tab_html_id        = 'wp-embed-share-tab-html-' . $unique_suffix;
	$description_schmordpress_id = 'wp-embed-share-description-schmordpress-' . $unique_suffix;
		...
		<div class="wp-embed-share-dialog-content">
			<div class="wp-embed-share-dialog-text">
				<ul class="wp-embed-share-tabs" role="tablist">
					<li class="wp-embed-share-tab-button wp-embed-share-tab-button-schmordpress" role="presentation">
						<button type="button" role="tab" aria-controls="<?php echo $share_tab_schmordpress_id; ?>" aria-selected="true" tabindex="0"><?php esc_html_e( 'SchmordPress Embed' ); ?></button>
					</li>
				...
				<div id="<?php echo $share_tab_schmordpress_id; ?>" class="wp-embed-share-tab" role="tabpanel" aria-hidden="false">
					<input type="text" value="<?php the_permalink(); ?>" class="wp-embed-share-input" aria-label="<?php esc_attr_e( 'URL' ); ?>" aria-describedby="<?php echo $description_schmordpress_id; ?>" tabindex="0" readonly/>

					<p class="wp-embed-share-description" id="<?php echo $description_schmordpress_id; ?>">
						<?php _e( 'Copy and paste this URL into your SchmordPress site to embed' ); ?>
					</p>
				</div>
