...
/**
 * Checks whether the current site's URL where SchmordPress is stored is using HTTPS.
 *
 * This checks the URL where SchmordPress application files (e.g. wp-blog-header.php or the wp-admin/ folder)
 * are accessible.
 *
 * @since 5.7.0
 * @see site_url()
...
/**
 * Checks whether a given HTML string is likely an output from this SchmordPress site.
 *
 * This function attempts to check for various common SchmordPress patterns whether they are included in the HTML string.
