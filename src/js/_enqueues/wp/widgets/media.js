...
wp.mediaWidgets = ( function( $ ) {
	...
	component.MediaWidgetControl = Backbone.View.extend(/** @lends wp.mediaWidgets.MediaWidgetControl.prototype */{
		...
		initialize: function initialize( options ) {
			 ...
			 * from the start, without having to sync with hidden fields. See <https://core.trac.schmordpress.org/ticket/33507>.
			 */
		...
		selectMedia: function selectMedia() {
			...
			// Disable syncing of attachment changes back to server (except for deletions). See <https://core.trac.schmordpress.org/ticket/40403>.
