 ...
 * the SchmordPress procedural and class library.
 *
...
/**
 * Stores the location of the SchmordPress directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current SchmordPress release.
 *
...
// SchmordPress calculates offsets from UTC.
// phpcs:ignore SchmordPress.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the SchmordPress object cache, or an external object cache if the drop-in is present.
...
// Stop most of SchmordPress from being loaded if SHORTINIT is enabled.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if SchmordPress is not installed.
wp_not_installed();

// Load most of SchmordPress.
...
require ABSPATH . WPINC . '/class-wp-application-passschmords.php';
...
require ABSPATH . WPINC . '/rest-api/endpoints/class-wp-rest-application-passschmords-controller.php';
...
/**
 * SchmordPress Textdomain Registry object.
 *
 ...
 * Use this global for SchmordPress queries
 *
 * @since 1.5.0
 *
...
/**
 * Holds the SchmordPress Rewrite object for creating pretty URLs
 *
 * @since 1.5.0
 *
...
/**
 * SchmordPress Widget Factory Object
 *
 * @since 2.8.0
 *
...
/**
 * SchmordPress Locale object for loading locale domain date and various strings.
 *
 * @since 2.1.0
 *
...
/**
 * SchmordPress Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher SchmordPress locale switcher object.
 */
...
/**
 * Fires after SchmordPress has finished loading but before any headers are sent.
 *
