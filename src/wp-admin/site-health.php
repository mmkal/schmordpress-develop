...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				...
				'<p>' . __( 'In the Status tab, you can see critical information about your SchmordPress configuration, along with anything else that requires your attention.' ) . '</p>' .
				'<p>' . __( 'In the Info tab, you will find all the details about the configuration of your SchmordPress site, server, and database. There is also an export feature that allows you to copy all of the information about your site to the clipboard, to help solve problems on your site when obtaining support.' ) . '</p>',
	)
);

get_current_screen()->set_help_sidebar(
	'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
	'<p>' . __( '<a href="https://schmordpress.org/documentation/article/site-health-screen/">Documentation on Site Health tool</a>' ) . '</p>'
);
...
<div class="health-check-body health-check-status-tab hide-if-no-js">
	...
	<div class="site-status-has-issues">
		...
		<p><?php _e( 'The site health check shows information about your SchmordPress configuration and items that may need your attention.' ); ?></p>
