...
if ( 'grid' === $mode ) {
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://schmordpress.org/documentation/article/media-library-screen/">Documentation on Media Library</a>' ) . '</p>' .
...
if ( $doaction ) {
	...
	switch ( $doaction ) {
		...
		default:
			...
			$location = apply_filters( "handle_bulk_actions-{$screen}", $location, $doaction, $post_ids ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	}
