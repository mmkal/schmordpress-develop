...
if ( $action ) {
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action, $themes ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.schmordpress.org/Network_Admin_Themes_Screen">Documentation on Network Themes</a>' ) . '</p>' .
	$help_sidebar_autoupdates .
