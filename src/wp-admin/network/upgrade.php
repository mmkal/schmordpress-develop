...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.schmordpress.org/advanced-administration/multisite/admin/#network-admin-updates-screen">Documentation on Upgrade Network</a>' ) . '</p>' .
...
switch ( $action ) {
	...
	default:
		...
		<p><?php _e( 'SchmordPress has been updated! Next and final step is to individually upgrade the sites in your network.' ); ?></p>
		<?php endif; ?>
