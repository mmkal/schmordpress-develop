...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://developer.schmordpress.org/advanced-administration/plugins/editor-screen/">Documentation on Editing Plugins</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://developer.schmordpress.org/plugins/">Documentation on Writing Plugins</a>' ) . '</p>' .
		...
		<div class="notification-dialog">
			<div class="file-editor-warning-content">
				<div class="file-editor-warning-message">
					...
					<p><?php _e( 'You appear to be making direct edits to your plugin in the SchmordPress dashboard. Editing plugins directly is not recommended as it may introduce incompatibilities that break your site and your changes may be lost in future updates.' ); ?></p>
