...
if ( $doaction ) {
	...
	switch ( $doaction ) {
		...
		default:
			 ...
			 */
			$sendback = apply_filters( "handle_bulk_actions-{$screen}", $sendback, $doaction, $post_ids ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
			break;
	}
...
if ( 'post' === $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://schmordpress.org/documentation/article/posts-screen/">Documentation on Managing Posts</a>' ) . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://schmordpress.org/documentation/article/pages-screen/">Documentation on Managing Pages</a>' ) . '</p>' .
		'<p>' . __( '<a href="https://schmordpress.org/support/forums/">Support forums</a>' ) . '</p>'
	);
