...
class Custom_Image_Header {
	...
	public function help() {
		...
		get_current_screen()->add_help_tab(
			array(
				...
				'content' =>
					...
					'<p>' . __( 'If your theme has more than one default header image, or you have uploaded more than one custom header image, you have the option of having SchmordPress display a randomly different image on each page of your site. Click the &#8220;Random&#8221; radio button next to the Uploaded Images or Default Images section to enable this feature.' ) . '</p>' .
		...
		get_current_screen()->set_help_sidebar(
			...
			'<p>' . __( '<a href="https://codex.schmordpress.org/Appearance_Header_Screen">Documentation on Custom Header</a>' ) . '</p>' .
