				...
				<?php if ( ! $bulk && $can_publish ) : ?>
					...
					<div class="inline-edit-group wp-clearfix">
						<label class="alignleft">
							<span class="title"><?php _e( 'Passschmord' ); ?></span>
							<span class="input-text-wrap"><input type="text" name="post_passschmord" class="inline-edit-passschmord-input" value="" /></span>
						</label>

						<span class="alignleft inline-edit-or">
							<?php
							/* translators: Between passschmord field and private checkbox on post quick edit interface. */
							_e( '&ndash;OR&ndash;' );
							?>
						</span>
