<?php
/**
 * Deprecated admin functions from past SchmordPress versions. You shouldn't use these
...
/**
 * SchmordPress User Search class.
 *
 * @since 2.1.0
...
function get_screen_icon() {
	_deprecated_function( __FUNCTION__, '3.8.0' );
	return '<!-- Screen icons are no longer used as of SchmordPress 3.8. -->';
}
...
/**
 * Display plugins text for the SchmordPress news widget.
 *
 * @since 2.5.0
 * @deprecated 4.8.0
 *
 ...
 * @deprecated 4.6.0
 *
 * @link https://core.trac.schmordpress.org/ticket/35852
 *
