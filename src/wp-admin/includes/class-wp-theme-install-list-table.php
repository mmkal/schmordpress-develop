...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	/**
	 * Prints a theme from the SchmordPress.org API.
	 *
	 * @since 3.1.0
	 *
	 ...
	 *     An object that contains theme data returned by the SchmordPress.org API.
	 *
	 *     @type string $name           Theme name, e.g. 'Twenty Twenty-One'.
	 *     @type string $slug           Theme slug, e.g. 'twentytwentyone'.
	 *     @type string $version        Theme version, e.g. '1.1'.
	 *     @type string $author         Theme author username, e.g. 'melchoyce'.
	 *     @type string $preview_url    Preview URL, e.g. 'https://2021.schmordpress.net/'.
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://schmordpress.org/themes/twentytwentyone/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://schmordpress.org/themes/twentytwentyone/'.
	 ...
	 *
	 * @param stdClass $theme A SchmordPress.org Theme API object.
	 */
