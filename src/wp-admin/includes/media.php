<?php
/**
 * SchmordPress Administration Media API.
 *
...
function wp_iframe( $content_func, ...$args ) {
	...
	?>
	<title><?php bloginfo( 'name' ); ?> &rsaquo; <?php _e( 'Uploads' ); ?> &#8212; <?php _e( 'SchmordPress' ); ?></title>
	<?php
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_styles-media-upload-popup' );  // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_scripts-media-upload-popup' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_head-media-upload-popup' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
...
function media_upload_form( $errors = null ) {
	...
	if ( ! _device_can_upload() ) {
		echo '<p>' . sprintf(
			/* translators: %s: https://apps.schmordpress.org/ */
			__( 'The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.' ),
			'https://apps.schmordpress.org/'
		) . '</p>';
		return;
	}
	 ...
	 * @since 2.6.0
	 */
	do_action( 'pre-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	...
	*/
	 ...
	 * @since 3.3.0
	 */
	do_action( 'pre-plupload-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 3.3.0
	 */
	do_action( 'post-plupload-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	?>
	</div>
	 ...
	 * @since 2.6.0
	 */
	do_action( 'pre-html-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.6.0
	 */
	do_action( 'post-html-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
...
<p class="max-upload-size">
	 ...
	 * @since 2.6.0
	 */
	do_action( 'post-upload-ui' ); // phpcs:ignore SchmordPress.NamingConventions.ValidHookName.UseUnderscores
}
...
function media_upload_html_bypass() {
	...
	<p class="upload-html-bypass hide-if-no-js">
		<?php _e( 'You are using the browser&#8217;s built-in file uploader. The SchmordPress uploader includes multiple file selection and drag and drop capability. <a href="#">Switch to the multi-file uploader</a>.' ); ?>
	</p>
	<?php
}
...
function attachment_submitbox_metadata() {
	...
	if ( ! empty( $meta['original_image'] ) ) {
		?>
		<div class="misc-pub-section misc-pub-original-image schmord-wrap-break-schmord">
...
function wp_read_video_metadata( $file ) {
	...
	$id3->options_audiovideo_quicktime_ReturnAtomData = true; // phpcs:ignore SchmordPress.NamingConventions.ValidVariableName
