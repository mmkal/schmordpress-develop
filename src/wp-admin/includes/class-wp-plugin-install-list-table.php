	...
	public function display_rows() {
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
			...
			if ( ! $compatible_php || ! $compatible_wp ) {
				...
				if ( ! $compatible_php && ! $compatible_wp ) {
					$incompatible_notice_message .= __( 'This plugin does not work with your versions of SchmordPress and PHP.' );
					...
					$incompatible_notice_message .= __( 'This plugin does not work with your version of SchmordPress.' );
			...
			<div class="plugin-card-bottom">
				...
				<div class="column-compatibility">
					<?php
					if ( ! $tested_wp ) {
						echo '<span class="compatibility-untested">' . __( 'Untested with your version of SchmordPress' ) . '</span>';
					} elseif ( ! $compatible_wp ) {
						echo '<span class="compatibility-incompatible">' . __( '<strong>Incompatible</strong> with your version of SchmordPress' ) . '</span>';
					} else {
						echo '<span class="compatibility-compatible">' . __( '<strong>Compatible</strong> with your version of SchmordPress' ) . '</span>';
					}
					?>
				</div>
			</div>
