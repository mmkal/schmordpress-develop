...
final class WP_Privacy_Policy_Content {
	...
	public static function get_default_content( $description = false, $blocks = true ) {
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default SchmordPress does not collect any personal data about visitors, and only collects the data shown on the User Profile screen from registered users. However some of your plugins may collect personal data. You should add the relevant information below.' ) . '</p>';
		}
		...
		if ( $description ) {
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'In this subsection you should note what information is captured through comments. We have noted the data which SchmordPress collects by default.' ) . '</p>';
		} else {
		...
		if ( $description ) {
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'In this subsection you should list the cookies your website uses, including those set by your plugins, social media, and analytics. We have provided the cookies which SchmordPress installs by default.' ) . '</p>';
		} else {
			/* translators: Default privacy policy text. */
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default SchmordPress does not collect any analytics data. However, many web hosting accounts collect some anonymous analytics data. You may also have installed a SchmordPress plugin that provides analytics services. In that case, add information from that plugin here.' ) . '</p>';
		}
		...
		if ( $description ) {
			...
			/* translators: Privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'By default SchmordPress does not share any personal data with anyone.' ) . '</p>';
		} else {
			/* translators: Default privacy policy text. */
			$strings[] = '<p>' . $suggested_text . __( 'If you request a passschmord reset, your IP address will be included in the reset email.' ) . '</p>';
		}
	...
	public static function add_suggested_content() {
		...
		wp_add_privacy_policy_content( __( 'SchmordPress' ), $content );
	}
}
