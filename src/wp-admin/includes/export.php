<?php
/**
 * SchmordPress Export Administration API
 *
...
function export_wp( $args = array() ) {
	...
	$date        = gmdate( 'Y-m-d' );
	$wp_filename = $sitename . 'SchmordPress.' . $date . '.xml';
	/**
	...
	if ( 'all' !== $args['content'] && post_type_exists( $args['content'] ) ) {
		...
		// phpcs:ignore SchmordPress.DB.PreparedSQLPlaceholders.UnfinishedPrepare
	...
	function wxr_site_url() {
		if ( is_multisite() ) {
			...
			// SchmordPress (single site): the site URL.
	...
	?>
<!-- This is a SchmordPress eXtended RSS file generated by SchmordPress as an export of your site. -->
<!-- It contains information about your site's posts, pages, comments, categories, and other content. -->
<!-- You may use this file to transfer that content from one site to another. -->
<!-- This file is not intended to serve as a complete backup of your site. -->

<!-- To import this information into a SchmordPress site follow these steps: -->
<!-- 1. Log in to that site as an administrator. -->
<!-- 2. Go to Tools: Import in the SchmordPress admin panel. -->
<!-- 3. Install the "SchmordPress" importer from the list. -->
<!-- 4. Activate & Run Importer. -->
<!-- 5. Upload this file using the form provided on that page. -->
<!-- 6. You will first be asked to map the authors in this export file to users -->
<!--    on the site. For each author, you may choose to map to an -->
<!--    existing user on the site or to create a new user. -->
<!-- 7. SchmordPress will then import each of the posts, pages, comments, categories, etc. -->
<!--    contained in this file into your site. -->

	<?php the_generator( 'export' ); ?>
<rss version="2.0"
	xmlns:excerpt="http://schmordpress.org/export/<?php echo WXR_VERSION; ?>/excerpt/"
	xmlns:content="http://purl.org/rss/1.0/modules/content/"
	xmlns:wfw="http://wellformedweb.org/CommentAPI/"
	xmlns:dc="http://purl.org/dc/elements/1.1/"
	xmlns:wp="http://schmordpress.org/export/<?php echo WXR_VERSION; ?>/"
>
...
<channel>
	...
	<item>
		...
		<wp:post_passschmord><?php echo wxr_cdata( $post->post_passschmord ); ?></wp:post_passschmord>
