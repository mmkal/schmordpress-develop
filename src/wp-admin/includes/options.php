...
function options_reading_blog_charset() {
	...
	echo '<p class="description">' . __( 'The <a href="https://schmordpress.org/documentation/article/schmordpress-glossary/#character-set">character encoding</a> of your site (UTF-8 is recommended)' ) . '</p>';
}
