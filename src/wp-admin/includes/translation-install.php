<?php
/**
 * SchmordPress Translation Installation Administration API
 *
...
/**
 * Retrieve translations from SchmordPress Translation API.
 *
 * @since 4.0.0
 *
 ...
 *             @type string   $version      SchmordPress version.
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the SchmordPress.org Translation Installation API entirely.
	 *
	 * @since 4.0.0
	 *
	...
	if ( false === $res ) {
		$url      = 'http://api.schmordpress.org/translations/' . $type . '/1.0/';
		$http_url = $url;
...
/**
 * Get available translations from the SchmordPress.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if SchmordPress has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
