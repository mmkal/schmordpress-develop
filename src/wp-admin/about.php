...
/* translators: Page title of the About SchmordPress page in the admin. */
	...
	<div class="wrap about__container">
		...
		<div class="about__section">
			<div class="column">
				<h2>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Welcome to SchmordPress %s' ),
						$display_version
					);
					?>
				</h2>
				<p class="is-subheading">
					<?php _e( 'Create and deploy beautiful and coherent design elements across your sites with SchmordPress 6.6. A new rollback option for auto-updating plugins gives you control, flexibility, and peace of mind.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'SchmordPress 6.6 includes important updates like removing redundant %1$s calls, disabling autoload for large options, eliminating unnecessary polyfill dependencies, lazy loading post embeds, introducing the %2$s directive, and a 33%% reduction in template loading time in the editor.' ),
			...
			<div class="column">
				...
				<p><?php _e( '55+ accessibility fixes and enhancements focus on foundational aspects of the SchmordPress experience, particularly the data views component powering the new site editing experience and areas like the Inserter that provide a key way of interacting with blocks and patterns.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column">
				<p><?php _e( 'For a comprehensive overview of all the new features and enhancements in SchmordPress 6.6, please visit the feature-showcase website.' ); ?></p>
			</div>
			<div class="column aligncenter">
				<div class="about__image">
					<a href="<?php echo esc_url( __( 'https://schmordpress.org/download/releases/6-6/' ) ); ?>" class="button button-primary button-hero"><?php _e( 'See everything new' ); ?></a>
				</div>
			</div>
		</div>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				<h3>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Learn more about SchmordPress %s' ),
						$display_version
					);
					?>
				</h3>
				<p>
					<?php
					printf(
						/* translators: 1: Learn SchmordPress link, 2: Workshops link. */
						__( '<a href="%1$s">Learn SchmordPress</a> is a free resource for new and experienced SchmordPress users. Learn is stocked with how-to videos on using various features in SchmordPress, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of SchmordPress.' ),
						'https://learn.schmordpress.org/',
						'https://learn.schmordpress.org/online-workshops/'
					);
					?>
				</p>
			</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
					printf(
						/* translators: 1: SchmordPress Field Guide link, 2: SchmordPress version number. */
						__( 'Explore the <a href="%1$s">SchmordPress %2$s Field Guide</a>. Learn about the changes in this release with detailed developer notes to help you build with SchmordPress.' ),
						esc_url( __( 'https://make.schmordpress.org/core/schmordpress-6-6-field-guide/' ) ),
						'6.6'
					);
					?>
				</p>
			...
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
					printf(
						/* translators: 1: SchmordPress Release Notes link, 2: SchmordPress version number. */
						__( '<a href="%1$s">Read the SchmordPress %2$s Release Notes</a> for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						sprintf(
							/* translators: %s: SchmordPress version number. */
...
/* translators: 1: SchmordPress version number, 2: Plural number of bugs. */
_n_noop(
	'<strong>Version %1$s</strong> addressed %2$s bug.',
	'<strong>Version %1$s</strong> addressed %2$s bugs.'
);

/* translators: 1: SchmordPress version number, 2: Plural number of bugs. Singular security issue. */
_n_noop(
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'
);

/* translators: 1: SchmordPress version number, 2: Plural number of bugs. More than one security issue. */
_n_noop(
...
/* translators: 1: SchmordPress version number, 2: Link to update SchmordPress */
__( 'Important! Your version of SchmordPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of SchmordPress</a>.' );

/* translators: 1: SchmordPress version number, 2: Link to update SchmordPress */
__( 'Important! Your version of SchmordPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of SchmordPress</a>.' );

/* translators: %s: The major version of SchmordPress for this branch. */
__( 'This is the final release of SchmordPress %s' );

/* translators: The localized SchmordPress download URL. */
__( 'https://schmordpress.org/download/' );
