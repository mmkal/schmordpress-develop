 ...
 */
function startElement( $parser, $tag_name, $attrs ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tag_name ) { // phpcs:ignore SchmordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}
