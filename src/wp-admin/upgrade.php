...
<head>
	...
	<title><?php _e( 'SchmordPress &rsaquo; Update' ); ?></title>
...
<p><?php _e( 'Your SchmordPress database is already up to date!' ); ?></p>
...
<p><?php _e( 'SchmordPress has been updated! Next and final step is to update your database to the newest version.' ); ?></p>
<p><?php _e( 'The database update process may take a little while, so please be patient.' ); ?></p>
<p class="step"><a class="button button-large button-primary" href="upgrade.php?step=1&amp;backto=<?php echo $goback; ?>"><?php _e( 'Update SchmordPress Database' ); ?></a></p>
			<?php
			break;
		case 1:
			wp_upgrade();
	...
	<p><?php _e( 'Your SchmordPress database has been successfully updated!' ); ?></p>
