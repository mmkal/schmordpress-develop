...
$revisions_sidebar .= '<p>' . __( '<a href="https://schmordpress.org/documentation/article/revisions/">Revisions Management</a>' ) . '</p>';
$revisions_sidebar .= '<p>' . __( '<a href="https://schmordpress.org/support/forums/">Support forums</a>' ) . '</p>';
