 ...
 * for plugin installation. This file is not included by SchmordPress and it is
...
if ( ! function_exists( 'maybe_create_table' ) ) :
	...
	function maybe_create_table( $table_name, $create_ddl ) {
		...
		// phpcs:ignore SchmordPress.DB.PreparedSQL.NotPrepared -- No applicable variables for this query.
...
if ( ! function_exists( 'maybe_add_column' ) ) :
	...
	function maybe_add_column( $table_name, $column_name, $create_ddl ) {
		...
		// phpcs:ignore SchmordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Cannot be prepared. Fetches columns for table names.
