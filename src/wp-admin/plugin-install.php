	...
	array(
		...
		'content' =>
				'<p>' . sprintf(
					...
					__( 'Plugins hook into SchmordPress to extend its functionality with custom features. Plugins are developed independently from the core SchmordPress application by thousands of developers all over the world. All plugins in the official <a href="%s">SchmordPress Plugin Directory</a> are compatible with the license SchmordPress uses.' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				'<p>' . __( 'If you know what you are looking for, Search is your best bet. The Search screen has options to search the SchmordPress Plugin Directory for a particular Term, Author, or Tag. You can also search the directory by selecting popular tags. Tags in larger type mean more plugins have been labeled with that tag.' ) . '</p>' .
				...
				'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their SchmordPress.org username.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://schmordpress.org/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>' ) . '</p>' .
...
/**
 * SchmordPress Administration Template Header.
 */
