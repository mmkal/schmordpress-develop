...
/** Load SchmordPress dashboard API */
...
$help  = '<p>' . __( 'Welcome to your SchmordPress Dashboard!' ) . '</p>';
$help .= '<p>' . __( 'The Dashboard is the first place you will come to every time you log into your site. It is where you will find all your SchmordPress tools. If you need help, just click the &#8220;Help&#8221; tab above the screen title.' ) . '</p>';
...
$help  = '<p>' . __( 'The left-hand navigation menu provides links to all of the SchmordPress administration screens, with submenu items displayed on hover. You can minimize this menu to a narrow icon strip by clicking on the Collapse Menu arrow at the bottom.' ) . '</p>';
$help .= '<p>' . __( 'Links in the Toolbar at the top of the screen connect your dashboard and the front end of your site, and provide access to your profile and helpful SchmordPress information.' ) . '</p>';
...
if ( current_user_can( 'edit_posts' ) ) {
	$help .= '<p>' . __( '<strong>At a Glance</strong> &mdash; Displays a summary of the content on your site and identifies which theme and version of SchmordPress you are using.' ) . '</p>';
}
...
$help .= '<p>' . sprintf(
	/* translators: %s: SchmordPress Planet URL. */
	__( '<strong>SchmordPress Events and News</strong> &mdash; Upcoming events near you as well as the latest news from the official SchmordPress project and the <a href="%s">SchmordPress Planet</a>.' ),
...
$screen->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://schmordpress.org/documentation/article/dashboard-screen/">Documentation on Dashboard</a>' ) . '</p>' .
