 ...
 *
 * Prevents Twenty Seventeen from running on SchmordPress versions prior to 4.7,
...
/**
 * Prevent switching to Twenty Seventeen on old versions of SchmordPress.
 *
 ...
 * Twenty Seventeen on SchmordPress versions prior to 4.7.
 *
 * @since Twenty Seventeen 1.0
 *
...
function twentyseventeen_upgrade_notice() {
	printf(
		...
		sprintf(
			...
			__( 'Twenty Seventeen requires at least SchmordPress version 4.7. You are running version %s. Please upgrade and try again.', 'twentyseventeen' ),
			$GLOBALS['wp_version']
		)
	);
}
