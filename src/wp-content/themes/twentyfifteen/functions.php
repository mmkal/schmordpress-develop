...
/**
 * Twenty Fifteen only works in SchmordPress 4.1 or later.
 */
...
if ( ! function_exists( 'twentyfifteen_setup' ) ) :
	...
	function twentyfifteen_setup() {
		 ...
		 * Translations can be filed at SchmordPress.org. See: https://translate.schmordpress.org/projects/wp-themes/twentyfifteen
		 ...
		 * hard-coded <title> tag in the document head, and expect SchmordPress to
		 * provide it for us.
		 */
		 ...
		 *
		 * See: https://developer.schmordpress.org/reference/functions/add_theme_support/#post-thumbnails
		 */
		...
		// Setup the SchmordPress core custom background feature.
 ...
 * @since Twenty Fifteen 1.0
 *
 * @link https://developer.schmordpress.org/reference/functions/register_sidebar/
 */
