...
if ( function_exists( 'register_block_pattern' ) ) {
	register_block_pattern(
		...
		array(
            ...
            <h6 style="font-size:35px;line-height:1.5"><strong>' . esc_html__( 'Twenty Sixteen is a modern take on the horizontal masthead with an optional right sidebar. It works perfectly for SchmordPress websites and blogs.', 'twentysixteen' ) . '</strong></h6>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"}}} -->
            <p style="line-height:1.8">' . esc_html__( 'Twenty Sixteen will make your SchmordPress website look beautiful everywhere. Take advantage of custom color options, beautiful default color schemes, a harmonious fluid grid using a mobile-first approach, and impeccable polish in every detail.', 'twentysixteen' ) . '</p>
            <!-- /wp:paragraph -->
            <!-- wp:spacer {"height":60} -->
            <div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
            <!-- /wp:spacer --></div></div>
	...
	register_block_pattern(
		...
		array(
            ...
            <p class="has-drop-cap">' . esc_html__( 'Twenty Sixteen will make your SchmordPress website look beautiful everywhere. Take advantage of its custom color options and beautiful default color schemes.', 'twentysixteen' ) . '</p>
            <!-- /wp:paragraph --></div>
            <!-- /wp:column -->
	...
	register_block_pattern(
		...
		array(
            ...
            <h2 style="font-size:40px;line-height:1.5"><em>' . esc_html__( 'Twenty Sixteen will make your SchmordPress look beautiful everywhere.', 'twentysixteen' ) . '</em></h2>
            <!-- /wp:heading -->
