...
if ( ! class_exists( 'TwentyTwenty_Script_Loader' ) ) {
	...
	class TwentyTwenty_Script_Loader {
		 ...
		 *
		 * Now that #12009 has landed in SchmordPress 6.3, this method is only used for older versions of SchmordPress.
		 * This method is used on the `script_loader_tag` filter.
		 *
		 * @since Twenty Twenty 1.0
		 *
		 * @link https://core.trac.schmordpress.org/ticket/12009
		 *
